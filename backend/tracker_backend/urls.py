...
from core.web_views import landing_view, admin_login_view, user_login_view, landing_home_view, landing_features_view, landing_benefits_view, landing_contact_view
...
urlpatterns = [
    ...
    path('home/', landing_home_view, name='landing-home'),
